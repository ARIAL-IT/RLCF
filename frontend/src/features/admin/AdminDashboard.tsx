        ...
        <div className="space-y-6 xl:col-span-1">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex justify-end">
                <Button onClick={handleExport} icon={<Download className="h-4 w-4" />} loading={exportDataset.isLoading}>
                  Export Data
                </Button>
              </div>
            </CardContent>
                    ...
                    <tr key={t.id} className="border-t border-slate-800 hover:bg-slate-800/50">
                      ...
                      <td className="p-2 text-right">
                        {t.status === 'BLIND_EVALUATION' && (
                          <Button size="sm" variant="secondary" onClick={() => handleAggregate(t.id)} loading={updateTaskStatus.isLoading}>
                            Aggregate
                          </Button>
                        )}
                      </td>
